package cn.caohangwei.mall.ucenter.dao;
...
public class Generator {
    ...
    private static final String MODULE = "mall-ucenter";
    private static final String DATABASE = "mall";
    private static final String TABLES_PREFIX = "ucenter";
    private static final String PACKAGE_NAME = "cn.caohangwei.mall.ucenter";
